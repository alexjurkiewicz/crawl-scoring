...
INTEGER_FIELDS = (
    'xl', 'sklev', 'lvl', 'absdepth', 'hp', 'mhp', 'mmhp', 'mp', 'mmp', 'bmmp', 'str', 'int', 'dex', 'ac', 'ev', 'sh', 'dur', 'turn', 'aut', 'kills',
    'gold', 'goldfound', 'goldspent', 'scrollsused', 'potionsused', 'sc', 'dam', 'sdam', 'tdam', 'start', 'end'
)
...
# Submit a body of:
# {"logfile": "v=0.22-a0:name=busb:..."}
# Note that : is escaped as ::
